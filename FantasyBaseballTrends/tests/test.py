...
class TestFunctions(unittest.TestCase):
    ...
    def test_intgetLastGame(self):
        ...
        assert_frame_equal(
            getLastGame(self.driver, "Aaron Judge"), testFrame, check_dtype=False,
        )
    ...
    def test_intgetLastxGames1(self):
        ...
        assert_frame_equal(
            getLastxGames(self.driver, "Aaron Judge", 5), testFrame, check_dtype=False,
        )

    def test_intgetLastxGames2(self):
        testFrame = pd.read_csv('FantasyBaseballTrends/tests/JudgeLast10.csv', index_col=0, dtype=str,)
        assert_frame_equal(
            getLastxGames(self.driver, "Aaron Judge", 10), testFrame, check_dtype=False,
        )
